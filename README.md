...
- 🛠️ **Smart Detection**: Monitors VS Code diagnostics (TypeScript, ESLint, Python, etc.) and terminal output (npm, cargo, tsc).
...
| --- | --- | --- |
| `mjBuildScreamer.enabled` | `true` | Enable/Disable the extension globally. |
| `mjBuildScreamer.volume` | `1.0` | Set playback volume (0.0 to 1.0). |
| `mjBuildScreamer.successSounds` | `true` | Play a notification when all errors are cleared. |
